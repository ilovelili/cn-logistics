const ja = {
  ...
  "appNotifications.title": "お知らせ",
  "appNotifications.unreadCount": "未読 {count}件",
  "appNotifications.markAllRead": "すべて既読",
  "appNotifications.unread": "未読",
  "appNotifications.all": "すべて",
  "appNotifications.empty": "お知らせはありません",
  ...
  "documents.previewFailed": "書類のプレビューを開けませんでした",
  ...
  "documents.action": "操作",
  "documents.downloadLocked": "DL承認後3日間DL可能",
  "documents.approval.notRequested": "未申請",
  "documents.approval.pending": "DL申請",
  "documents.approvalPendingIndicator": "新しい書類DL承認申請があります",
  ...
  "form.consignee": "荷受人",
  "form.consignor": "荷送人",
  "form.noCustomersAvailable": "選択可能な顧客がありません",
  "form.selectCustomer": "顧客を選択",
  ...
  "admin.userRegistration.contactPerson": "客先担当",
  "admin.userRegistration.contactAndEmail": "客先担当",
  "admin.userRegistration.contacts": "客先担当・メールアドレス",
  "admin.userRegistration.addContact": "客先担当を追加",
  ...
  "admin.userRegistration.status.changePending": "変更承認待ち",
  ...
  "admin.entry.requestAssignmentChange": "担当変更を申請",
...
const en: Messages = {
  ...
  "appNotifications.title": "Notifications",
  "appNotifications.unreadCount": "{count} unread",
  "appNotifications.markAllRead": "Mark all as read",
  "appNotifications.unread": "Unread",
  "appNotifications.all": "All",
  "appNotifications.empty": "No notifications",
  "appNotifications.actor": "Requested or updated by",
  ...
  "notifications.updateType": "Update type",
  ...
  "status.departure": "Flight/vessel departed",
  ...
  "feedback.targetRole": "Feedback target",
  ...
  "feedback.totalScore": "Total rating score",
  ...
  "documents.previewFailed": "Failed to open document preview",
  ...
  "documents.downloadLocked": "Available for 3 days after approval",
  "documents.approval.notRequested": "Not requested",
  "documents.approval.pending": "DL request",
  "documents.approvalPendingIndicator":
    "A new document download approval request is pending",
  ...
  "form.noCustomersAvailable": "No customers available",
  ...
  "form.containerLength": "Container length",
  ...
  "admin.userRegistration.status.changePending": "Change approval pending",
  ...
  "admin.userRegistration.assignedAdminsDescription":
    "Select one or more Ops and Sales contacts assigned to this shipper.",
  ...
  "admin.entry.requestAssignmentChange": "Request contact change",
  "admin.userRegistration.approvedReadOnly":
