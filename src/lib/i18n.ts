...
const en: Messages = {
  ...
  "jobs.searchPlaceholder":
    "Search invoice #, company, assignee, shipper, consignee, POL/AOL, POD/AOD, BL/AWB, documents...",
  "jobs.filter.allCompanies": "All companies",
  ...
  "documents.searchPlaceholder":
    "Search document, company, assignee, invoice #...",
  ...
  "form.selectCompany": "Select company",
  ...
  "admin.nav.userRegistration": "Company registration",
  ...
  "admin.userRegistration.title": "Company registration",
  "admin.userRegistration.dashboard": "Registered companies",
  "admin.userRegistration.newUser": "Register company",
  "admin.userRegistration.noUsers": "No registered companies yet.",
  "admin.userRegistration.noMatches": "No companies match the current filters.",
  "admin.userRegistration.count": "{count}",
  "admin.userRegistration.searchPlaceholder":
    "Search company, email, assigned admin...",
  "admin.userRegistration.email": "Email",
  "admin.userRegistration.companyName": "Company",
  "admin.userRegistration.zipcode": "Postal code",
  "admin.userRegistration.companyAddress": "Address",
  "admin.userRegistration.telephone": "Phone",
  "admin.userRegistration.budget": "Budget",
  "admin.userRegistration.budgetUnit": "10k JPY",
  "admin.userRegistration.contactPerson": "Assignee",
  ...
  "admin.userRegistration.loadFailed": "Failed to load registered companies",
  "admin.userRegistration.created": "Company registered. Approval is pending.",
  "admin.userRegistration.createFailed": "Failed to register company",
  "admin.userRegistration.updateFailed": "Failed to update company",
  "admin.userRegistration.assignedAdmins": "Assigned admins",
  "admin.userRegistration.assignedAdminsDescription":
    "Select one or more admins to assign.",
  "admin.userRegistration.assignmentUpdateFailed":
    "Failed to update assigned admins",
  ...
  "admin.userRegistration.deleted": "Company deleted",
  "admin.userRegistration.deleteFailed": "Failed to delete company",
  "admin.userRegistration.confirmTitle": "{action}?",
  "admin.userRegistration.confirmApprove": "Approve this company registration.",
  "admin.userRegistration.confirmReject": "Reject this company registration.",
  "admin.userRegistration.confirmDelete":
    "This company will be deleted and will no longer be able to log in.",
  ...
  "superAdmin.switch.normalUsers": "Normal users",
